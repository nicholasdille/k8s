...
rm kubernetes-dasahboard.yaml
wget https://raw.githubusercontent.com/kubernetes/dashboard/master/src/deploy/recommended/kubernetes-dashboard.yaml
patch kubernetes-dashboard.yaml < dashboard.patch
kubectl -n kube-system delete serviceaccount my-dashboard-sa
kubectl -n kube-system create serviceaccount my-dashboard-sa
kubectl -n kube-system delete clusterrolebinding my-dashboard-sa
